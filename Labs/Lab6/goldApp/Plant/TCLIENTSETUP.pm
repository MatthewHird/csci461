package goldApp::Plant::TCLIENTSETUP;
#================================================================--
# File Name    : TCLIENTSETUP.pm
#
# Purpose      : Goldberg client batch test Set-Up
#
...
sub start {
   ...
   Tosf::Table::SVAR->add(name => "sv_regReq", value => 1);
   ...
   $sem = "TestClientControlSem";
   $task = "TestClientControl";

   Tosf::Table::TASK->new(
      name => $task, 
      periodic => TRUE, 
      period => Tosf::Executive::TIMER->s2t(0.1),
      fsm => goldApp::Fsm::TCLIENTCONTROL->new(
         taskName => $task, 
         taskSem => $sem,
	 handlerName => "HostManager",
	 handlerSem => "HostManagerSem",
